...
//---
   ...
   if(AfterNewsStop>0)
     {
      ...
      string NewsTLG = StringFormat("In %d minutes, news for %s < %s> will be released! ", (int)(TimeNewsFunck(i)-TimeCurrent())/60, NewsArr[1][i], NewsArr[3][i]);
   ...
   SendTelegramMessage( TelegramApiUrl, TelegramBotToken, ChatId,
                                NewsTLG + TimeToString( TimeLocal() ),
                                "MyScreenshot.png" );
                      Sleep(10000);
      
      Alert("In ",(int)(TimeNewsFunck(i)-TimeCurrent())/60," minutes released news ",NewsArr[1][i],"_",NewsArr[3][i]);Now=i;
      }
/***  ***/
     }
...
string ReadCBOE()
  {
   ...
   string cookie="Referer: https://www.investing.com/economic-calendar/\r\nUser-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 16_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.3 Mobile/15E148 Safari/604.1\r\n",headers;
